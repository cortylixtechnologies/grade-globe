...
const Materials = () => {
  ...
  const verifyAccessCode = async () => {
    ...
    // Check if code exists for this material and is either:
    // 1. Available (pre-generated by admin) and not used
    // 2. Approved (user-requested and admin-approved) and not used
    ...
    if (codeData) {
      ...
      // Check if the code exists but is pending
      ...
      if (pendingCode) {
        toast({
          ...
          description: "Your control number is awaiting admin approval. Please complete payment and wait for verification.",
          variant: "destructive",
        });
      } else {
        toast({
          title: "Invalid Code",
          description: "The code is incorrect, rejected, or has already been used.",
          variant: "destructive",
        });
      }
    }
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <Dialog open={showAccessDialog} onOpenChange={setShowAccessDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Enter Access Code / Control Number</DialogTitle>
            <DialogDescription>
              Enter the code you received for: <strong>{selectedMaterial?.title}</strong>
            </DialogDescription>
          </DialogHeader>
          
          <div className="py-4">
            <Input
              placeholder="Enter your code (e.g., ASA-2025-XXXXX)"
              value={accessCodeInput}
              onChange={(e) => setAccessCodeInput(e.target.value.toUpperCase())}
              className="text-center font-mono text-lg"
            />
            <p className="text-xs text-muted-foreground mt-2 text-center">
              Don't have a code? Click "Request Access" to get a control number.
            </p>
          </div>
